...
## Featured Work
- **Real-time Apple Media Telemetry Anomaly Detection (Kafka + Spark + GenAI)** — streaming pipelines + metric regressions + dashboards.  
...
- [DSP & Control Systems](./control-dsp/)
